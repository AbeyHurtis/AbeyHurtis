...
Recent projects include accelerating deep learning models on FPGAs, analyzing large-scale research metadata,
and improving database-driven backend systems.
```
