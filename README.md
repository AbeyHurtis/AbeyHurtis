...
```
Passionate about building systems that perform better through thoughtful integration of hardware and software.
Recent projects include accelerating deep learning models on FPGAs,
analyzing large-scale research metadata, and improving database-driven backend systems.
```
